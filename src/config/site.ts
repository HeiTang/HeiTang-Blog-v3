...
export const siteConfig = {
  ...
  projectsWhitelist: [
    ...
    },
    {
      ...
      highlights: [
        '支援中文自然語言輸入，例如「明天下午三點提醒我倒垃圾」。',
        '時間或事項不足時會主動追問，並提供常用時間快捷按鈕。',
        '群組可用指令、@bot 或管理員開啟的一般文字模式觸發。',
        'DB-driven scheduler 固定掃描並 claim 到期提醒，重啟後不會遺失排程。',
        '提醒送出後可一鍵延後 10 分鐘、1 小時或明天同時間。',
      ],
      screenshots: [],
    ...
    },
    {
      ...
      highlights: [
        '將 starred repos 分類成 format、platforms、topics 三維 schema。',
        '產生互動式 Dataview hub，支援 preset、chip filter、topic 搜尋、星數門檻與欄位排序。',
        '純 Bash 流程可在 macOS、Linux、WSL2 執行，不綁定特定 AI agent。',
        '支援 diff-only、只更新統計、unstar 刪檔、補 topic、重新分類等日常維護工作流。',
      ],
      screenshots: [],
    ...
    },
    {
      ...
      highlights: [
        '補足 Medium 沒有原生 follows OPML 匯出的缺口。',
        '輸出標準 OPML，可直接匯入常見 RSS reader。',
        '零後端、零依賴，安裝 userscript 後在瀏覽器端完成匯出。',
      ],
      screenshots: [],
    ...
    },
    {
      ...
      highlights: [
        '自動掃描頁面 PDF 連結並集中下載。',
        '浮動面板顯示下載成功與失敗列表，方便回頭補抓。',
        '以 userscript 形式安裝，不需要額外後端服務。',
      ],
      screenshots: [],
    ...
    },
    {
      ...
      highlights: [
        '收集逢甲大學 101 學年度起的課程資訊，降低重複爬取成本。',
        '提供依學年度參數更新資料的 Python 工具。',
        '搭配 FCU-CourseAPI 記錄查詢 payload 與 response 格式。',
        '搭配 FCU-ClassID 維護學院、系所、班級 ID 對照資料。',
      ],
      screenshots: [],
